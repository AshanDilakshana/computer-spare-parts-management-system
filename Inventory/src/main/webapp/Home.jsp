 ...
 <body>
    ...
    <div class="box_set">
      <form class="boximg" action="viewAll" method="post">
        <img src="CSS/loff.jpg" alt="imgadd" class="img_one" />
        <button class="nebtn">View Details</button>
      </form>
      <div class="boximg">
        <img src="CSS/vectrimg.jpg" alt="imgadd" class="img_one" />
        <a href="http://localhost:8090/Inventory/Insert.jsp">
          <button class="nebtn">Add New</button></a
        >
      </div>
    </div>
